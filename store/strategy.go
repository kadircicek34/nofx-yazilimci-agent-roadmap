...
type IndicatorConfig struct {
	...
	// OpenBB enrichment
	EnableOpenBB         bool     `json:"enable_openbb"`
	EnableOpenBBMacro    bool     `json:"enable_openbb_macro"`
	EnableOpenBBNews     bool     `json:"enable_openbb_news"`
	EnableOpenBBTechnical bool    `json:"enable_openbb_technical"`
	OpenBBNewsLimit      int      `json:"openbb_news_limit,omitempty"`
	OpenBBHistoryDays    int      `json:"openbb_history_days,omitempty"`
	OpenBBTimeoutSeconds int      `json:"openbb_timeout_seconds,omitempty"`
	OpenBBCacheTTLSeconds int     `json:"openbb_cache_ttl_seconds,omitempty"`
	OpenBBMacroSymbols   []string `json:"openbb_macro_symbols,omitempty"`
}
...
func GetDefaultStrategyConfig(lang string) StrategyConfig {
	...
	config := StrategyConfig{
		...
		Indicators: IndicatorConfig{
			...
			// OpenBB enrichment
			EnableOpenBB:          true,
			EnableOpenBBMacro:     true,
			EnableOpenBBNews:      true,
			EnableOpenBBTechnical: true,
			OpenBBNewsLimit:       4,
			OpenBBHistoryDays:     90,
			OpenBBTimeoutSeconds:  45,
			OpenBBCacheTTLSeconds: 900,
			OpenBBMacroSymbols:    []string{"SPY", "QQQ", "DX-Y.NYB", "GLD", "CL=F", "^VIX"},
		},
