...
export interface IndicatorConfig {
  ...
  // OpenBB enrichment
  enable_openbb?: boolean;
  enable_openbb_macro?: boolean;
  enable_openbb_news?: boolean;
  enable_openbb_technical?: boolean;
  openbb_news_limit?: number;
  openbb_history_days?: number;
  openbb_timeout_seconds?: number;
  openbb_cache_ttl_seconds?: number;
  openbb_macro_symbols?: string[];
}
