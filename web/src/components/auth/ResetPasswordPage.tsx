...
export function ResetPasswordPage() {
  ...
  const [publicResetEnabled, setPublicResetEnabled] = useState(false)
  ...
  useEffect(() => {
    getSystemConfig()
      .then((config) => setPublicResetEnabled(Boolean(config.public_password_reset_enabled)))
      .catch(() => setPublicResetEnabled(false))
            ...
            {!configLoaded ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm" style={{ color: '#848E9C' }}>
                  Sign in to your account and change your password from the authenticated settings flow.
                </p>
              </div>
            ) : success ? (
              <div className="text-center py-8">
